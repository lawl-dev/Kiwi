...
namespace Kiwi.Parser.Nodes
{
    public class ReverseForInStatementSyntax : ForInStatementSyntax
    {
        public ReverseForInStatementSyntax(
            ...
            List<IStatementSyntax> statements) : base(variableDeclarationStatement, collExpression, statements)
        {
        }
        ...
        public ReverseForInStatementSyntax(
            ...
            IExpressionSyntax collExpression,
            List<IStatementSyntax> statements) : base(itemExpression, collExpression, statements)
        {
        }
